...
public class ArrayListTest01 {
	...
	public static void main(String[] args) {
		...
		//삭제도 같다.
		list1.remove(3); //index로 삭제
		list1.remove("bbb"); //데이터를 찾아서 삭제
		...
		list2.add("DDDD");
		list2.add("EEEE");
		//list2.add(1234); //문자열이 아니면 오류
		
		for (int i = 0; i < list2.size(); i++) {
			System.out.println(i+"번째 list2 값 : "+list2.get(i));
		}
		...
		// - indexOf()메소드는 검색 방향이 앞에서 뒤쪽으로 검색하고,
		//   lastIndexOf()메소드는 검색방향이 뒤에서 앞쪽으로 검색한다.
